...
export default function Screen3(){
    return <View>
      ...
      <Image source={require("../assets/example.png")} style={{height:0.24*deviceHeight,marginTop:'5%',marginBottom:'10%',width:deviceWidth*0.6,resizeMode:'contain',marginRight:deviceWidth*0.2,marginLeft:deviceWidth*0.2}}/>
