...
export default function Screen3(){
    return <View>
      ...
      <Image source={require("../assets/sc.jpeg")}  style={{height:0.24*deviceHeight,marginTop:'10%',marginBottom:'10%',width:deviceWidth*0.52,resizeMode:'contain',marginRight:'auto',marginLeft:'auto'}}/>

      <Image source={require("../assets/bottom.jpg")}  style={{height:0.1*deviceHeight,marginTop:'auto',width:deviceWidth,resizeMode:'cover',marginRight:'auto',marginTop:'11%'}}/>
