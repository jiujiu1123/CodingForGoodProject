...
export default class HelloWorldSceneAR extends Component {
  constructor() {
    ...
    this.state = {
      text: 'Tap the smileys',
      counter: 0,
      textScale: [0, 0, 0],
      scale1: [0.15, 0.15, 0.15],
      scale2: [0.13, 0.13, 0.13],
      scale3: [0.15, 0.15, 0.15],
      scale4: [0.13, 0.13, 0.13],
      scale5: [0.1, 0.1, 0.1],
      scale6: [0.1, 0.1, 0.1],
    ...
    this._checkCounter = this._checkCounter.bind(this);
  ...
  render() {
    ...
    return (
      <ViroARScene onTrackingUpdated={this._onInitialized} >
        ...
        <ViroText position={[0,0,-5]} style={styles.helloWorldTextStyle} text={this.state.text} />
